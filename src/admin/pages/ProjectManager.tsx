        ...
        <div>
                        ...
                        <div className="relative h-48 bg-[#090325] overflow-hidden group-hover:scale-[1.02] transition-transform duration-500">
                            ...
                            <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
                                {project.sourceCodeLink && (
                                    <a href={project.sourceCodeLink} target="_blank" rel="noreferrer" className="p-2 bg-gray-900 rounded-full text-white hover:text-cyan-400 hover:bg-white transition-all transform hover:scale-110">
                                        <Github className="w-6 h-6" />
                                    </a>
                                )}
                                {project.demoLink && (
                                    <a href={project.demoLink} target="_blank" rel="noreferrer" className="p-2 bg-gray-900 rounded-full text-white hover:text-purple-400 hover:bg-white transition-all transform hover:scale-110">
                        ...
                        <div className="p-6 flex-1 flex flex-col relative">
                            ...
                            <div className="flex flex-wrap gap-2 mb-4">
                                {project.tags?.slice(0, 3).map((tag: any, i: number) => (
                                    <span key={i} className="text-[10px] px-2 py-1 rounded-full bg-[#1d1836] text-gray-300 border border-[#2b2b42]">
            ...
            >
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-300 mb-2">Tools/Tags (comma separated)</label>
                        <input
                            {...register('tags')}
                            className="w-full bg-[#1d1836] text-white px-4 py-3 rounded-lg border border-[#2b2b42] focus:border-purple-500 focus:ring-1 focus:ring-purple-500 outline-none transition-all placeholder-gray-500"
