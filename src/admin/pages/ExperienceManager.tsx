        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <label
                htmlFor="logo-upload"
                className={`flex items-center gap-2 px-4 py-2 rounded-lg border border-[#2b2b42] cursor-pointer hover:bg-[#2b2b42] transition-colors ${
