...
import { Briefcase, GraduationCap, Wrench, FolderKanban, Database, Zap, Loader2, Trash2 } from 'lucide-react';
...
const Dashboard = () => {
    ...
    const { getAll: getExperience, add: addExperience, remove: removeExperience } = useFirestore('experience');
    const { getAll: getEducation, add: addEducation, remove: removeEducation } = useFirestore('education');
    ...
    const openResetModal = () => {
        setConfirmConfig({
            ...
            message: 'WARNING: This will delete ALL data from the database. This action cannot be undone. Are you sure you want to proceed?',
            isDestructive: true
        });
    };
    ...
    const openSeedModal = () => {
        setConfirmConfig({
            ...
            message: 'This will populate the database with default sample data. New entries will be created.',
            isDestructive: false
        });
    };
        ...
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 animate-in fade-in slide-in-from-top-4 duration-500">
                <div className="relative">
                    ...
                    <h1 className="text-4xl font-bold text-white mb-2">
                        Welcome Back, <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400">Admin</span>
                    </h1>
                    <p className="text-gray-400 max-w-lg">
                        Manage your portfolio content, track your projects, and keep your professional profile up to date.
                    </p>
                </div>
                ...
                <div className="flex gap-4">
                    ...
                    >
                        ...
                        <div className="relative flex items-center gap-2">
                            {reseting ? <Loader2 className="w-5 h-5 animate-spin" /> : <Trash2 className="w-5 h-5 group-hover:scale-110 transition-transform" />}
                            <span className="font-medium">
                                {reseting ? 'Reseting...' : 'Reset Data'}
                            </span>
                        </div>
                    </button>
                    ...
                    >
                        ...
                        <div className="relative flex items-center gap-2">
                            {seeding ? <Loader2 className="w-5 h-5 animate-spin text-purple-500" /> : <Database className="w-5 h-5 text-purple-500 group-hover:scale-110 transition-transform" />}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
                <div className="lg:col-span-2 bg-[#151030] p-6 rounded-2xl border border-[#2b2b42] relative overflow-hidden">
                    ...
                    <div className="h-48 flex items-end justify-between gap-2 px-4">
                        ...
                        {[40, 70, 45, 90, 60, 80, 50].map((h, i) => (
                            <div key={i} className="w-full bg-[#231e45] rounded-t-lg relative group overflow-hidden">
                                <div
                ...
                <div className="bg-gradient-to-br from-[#1d1836] to-[#151030] p-6 rounded-2xl border border-[#2b2b42] flex flex-col justify-center items-center text-center">
                    ...
                    <p className="text-gray-400 text-sm mb-6">Your portfolio is active and configured. Keep adding projects to increase visibility.</p>
                    <a
                        href="/"
                        target="_blank"
